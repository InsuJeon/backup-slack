...
.. code-block:: console
   ...
   $ pip install -e git+git://github.com/InsuJeon/backup-slack.git#egg=backup_slack

or `pipsi <https://github.com/mitsuhiko/pipsi>`_:

.. code-block:: console

   $ pipsi install -e git+git://github.com/InsuJeon/backup-slack.git#egg=backup_slack
